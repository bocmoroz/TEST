...
(
    ...
    CONSTRAINT incomeProductsCount_productId_fkey FOREIGN KEY (product_id)
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT incomeProductsCount_productIncomeId_fkey FOREIGN KEY (product_income_id)
...
(
    ...
    count integer,
    product_id bigint NOT NULL,
    CONSTRAINT saleProductsCount_productSaleId_fkey FOREIGN KEY (product_sale_id)
...
(
    ...
    count integer,
    product_id bigint NOT NULL,
    CONSTRAINT transportationProductsCount_productTransportationId_fkey FOREIGN KEY (product_transportation_id)
